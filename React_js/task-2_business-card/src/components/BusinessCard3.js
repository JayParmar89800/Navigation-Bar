  ...
  return (
    <>
        <div className='container-fluid card-bg card-bg3 w-75 d-flex flex-column justify-content-evenly align-items-center text-white row-gap-3'>
                <p className='fs-4 fw-bold mb-0 text-center'>{formData.companyName}</p>
                <img src={formData.CompanyLogo?formData.CompanyLogo:companylogo} alt='logo not found' className='border border-1 rounded-circle img-fluid object-fit-cover' style={{height:'150px',width:'150px'}}/>
                ...
                <div className='text-center text-primary fw-bold fst-italic border-top border-primary'>
                    " {formData.TagLine} "
                </div>
        </div>
    </>
